// src/components/admin/documents/client/irisAnalysisTypes.ts
// Re-exporta todos os tipos e constantes da ferramenta de íris.
// Os arquivos em iris-analysis/ usam './types'; os de documents/client/ usam este módulo.
...
/**
 * Registro persistido por cliente em clients.iris_analysis (JSONB).
 * Lado a lado com contrast_layout, ai_info_tags, etc.
 */
export interface IrisAnalysisRecord extends IrisCardState {
  /** PNG já renderizado — usado em prompts e como miniatura. */
...
/** Dimensões fixas do card gerado (1200 × 600 px). */
