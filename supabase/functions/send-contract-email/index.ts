      ...
      if (client) {
        ...
        await supabase.functions.invoke('send-contract-email', {
          body: {
            ...
            // Fix 1: clientToken como fallback — quando o contexto anon bloqueia
            // a leitura de admin_id por RLS, a Edge Function resolve sozinha via
            // service role usando este token (query acima retornava null).
            clientToken: token,
            clientName: client.full_name,
            clientEmail: client.email,
            planName,
